// -----
// AnalogButton.h - Library for detecting button clicks, doubleclicks and long press pattern on a single button.
...
public:
	// ----- Constructor -----
	AnalogButton(int pin, int activeValue);
	...
	// set # tolerance value +-10 ist default.
...
private:
	...
	bool checkLevel(int buttonLevel); //Help function
};
